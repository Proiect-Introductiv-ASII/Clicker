        ...
        <div className="about-content">
          <section>
            ...
            <p>
              ...
              Clicker takes a retro approach to idle gameplay by using
              minimalist text-based visuals.
            </p>
          </section>
        </div>
      </div>
      ...
      <div className="about-container">
        <div className="about-content">
          <section>
            ...
            <p>
              In this game, players start by clicking to earn points. These
              points can then be used to unlock new upgrades, automate clicks,
              and progress further. Each upgrade contributes to the strategic
      ...
      <div className="about-container">
        <div className="about-content">
          <section>
            ...
            <p>
              We are working on adding more features to enhance the gameplay,
              such as new upgrade paths, leaderboards, and achievements to reward the
      ...
      <div className="about-container">
        <div className="about-content">
          <section>
            ...
            <p>
              This project was created as part of an ongoing learning journey
              into game development. If you have any suggestions, feel free to
              reach out via email: tionix1234@gmail.com.
            </p>
          </section>
        </div>
      </div>
